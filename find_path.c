...
/*   Updated: 2024/04/05 17:10:01 by suminkwon        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char *strjoin_path(t_path *s_p, char ***split_cmd)
{
	...
	while (s_p->split_path[s_p->i])
	{
		...
		{
			// ft_putstr_fd("find right path \n", 2);
			// ft_putstr_fd (s_p->tmp,2);
			// ft_putchar_fd('\n',2);
